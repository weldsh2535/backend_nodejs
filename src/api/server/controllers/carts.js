...
class CartsController {
  ...
  static create(req, res, next) {
    ...
    ProductDal.get({
      ...
      console.log("Products ID::"+cats._id);
      console.log("STOCK::"+cats.qty);
      SalesDal.getCollection({
        ...
        if(iSales.length > 0){
          ...
          difference = cats.qty - iSales.length;
        }else{
          console.log("Sales::NULL");
          difference = cats.qty - 0;
        }
        console.log("STOCK::"+cats.qty);
        console.log("DIFF::"+difference);
        if (difference > 0) {
          body.customer = req.user.customer;
          body.created_at = now;
